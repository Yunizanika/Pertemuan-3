...
/*
Akses modifier di Kotlin terdiri dari final, open, abstract, dan override.
Akses modifier di Kotlin
berpengaruh terhadap perwarisan (inheritance).
Secara default seluruh fungsi dan kelas di Kotlin apabila tidak terdapat akses modifier-nya maka secara implisit akses modifier-nya adalah final.
Sehingga apapun kelas dan method di Kotlin harus memiliki akses modifier open untuk
...
dan method. Ketika sebuah kelas ditandai sebagai abstrak, maka secara implisit ia juga memiliki
akses modifier open jadi kita tidak perlu memberikan akses modifier open ketika
mendeklarasikan fungsi didalam kelas abstrak tersebut.
 */